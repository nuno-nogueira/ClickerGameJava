...
public class BuildingSystem {
    ...
    public BuildingSystem(GameState gamestate, CriticalSystem criticalSystem, GoldenCookieSystem goldenCookieSystem) {
        upgrades.put("cursor", new Building("Cursor", 15, 0, 0.5, 1.0d, "critChance", 0.2d, 0, 1.15));
        upgrades.put("grandma", new Building("Grandma", 100, 0, 3, 1.0d, "global", 0.5d, 0, 1.18));
        upgrades.put("farm", new Building("Farm", 500, 0, 12, 1.0d, "goldenCookie", 0.5d, 0, 1.20));
        upgrades.put("mine", new Building("Mine", 2000, 0, 40, 1.0d, "critPower", 0.1d, 0, 1.23));
        upgrades.put("wizard", new Building("Wizard Tower", 10000, 0, 120, 1.0d, "critChance", 0.3d, 0, 1.25));
        upgrades.put("bank", new Building("Bank", 50000, 0, 400, 1.0d, "global", 1.0d, 0, 1.27));
        upgrades.put("temple", new Building("Temple", 200000, 0, 1500, 1.0d, "global", 2.0d, 0, 1.30));
